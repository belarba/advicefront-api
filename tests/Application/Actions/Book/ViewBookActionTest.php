...
class ViewBookActionTest extends TestCase
{
    public function testAction()
    {
        ...
        $request = $this->createRequest('GET', '/books/1');
    ...
    public function testActionThrowsBookNotFoundException()
    {
        $app = $this->getAppInstance();
        ...
        $payload = (string) $response->getBody();
        $expectedError = new ActionError(ActionError::RESOURCE_NOT_FOUND, 'The book you requested does not exist.');
