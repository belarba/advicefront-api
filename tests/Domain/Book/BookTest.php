...
class BookTest extends TestCase
{
     ...
     */
    public function testGetters(int $id, string $title, int $isbn, string $coverUrl, string $description)
    {
        $book = new Book($id, $title, $isbn, $coverUrl, $description);
     ...
     * @param string    $description
     */
    public function testJsonSerialize(int $id, string $title, int $isbn, string $coverUrl, string $description)
    {
        ...
        $this->assertEquals($expectedPayload, json_encode($book));
    }
}
